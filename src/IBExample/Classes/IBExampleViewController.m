...
- (void)viewDidLoad {
	...
	TelaInfuncionalViewController* telaVC = [[TelaInfuncionalViewController alloc] initWithNibName:@"TelaInfuncionalViewController" bundle:nil];
	 
	[self.view addSubview:telaVC.view];
